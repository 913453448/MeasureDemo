...
public class MeasureView2 extends View {
    ...
    public MeasureView2(Context context) {
        this(context, null);
    }

    public MeasureView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeasureView2(Context context, AttributeSet attrs, int defStyleAttr) {
